...
- **Visual Indicators**: Shovel icon (🛠️) = split needed | Envelope icon (✉️) = ready to mail
...
### **Optional**
- **Bagnon**: Enhanced bag highlighting for order fulfillment (future feature)
...
- **CurseForge Issues**: [Report here](https://www.curseforge.com/wow/addons/togbankclassic/issues)
- **GitHub**: [TOGBankClassic Repository](https://github.com/EY3G0R3/TOGBankClassic)
